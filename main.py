...
def portal_trabajador(token: str, request: Request, db: Session = Depends(get_db)):
    ...
    response = templates.TemplateResponse(request, "portal_trabajador.html", {
        "request": request, "trabajador": t, "epis": epis, "hoy_items": hoy_items,
